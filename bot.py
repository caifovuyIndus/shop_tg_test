...
TEXTS = {
    "ru": {
        ...
        "ref_earned": "💰 Скидка от рефералов на данный момент: {value}€",
    ...
    "ua": {
        ...
        "ref_earned": "💰 Знижка від рефералів на даний момент: {value}€",
        "stats_title": "📊 Статистика",
    ...
    "de": {
        ...
        "ref_earned": "💰 Aktueller Rabatt durch Empfehlungen: {value}€",
